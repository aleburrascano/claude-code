...
🌐 **Language / Ngôn ngữ / 语言 / Мова:** [English](https://github.com/luongnv89/claude-howto/blob/main/README.md) | [Tiếng Việt](https://github.com/luongnv89/claude-howto/blob/main/vi/README.md) | [中文](https://github.com/luongnv89/claude-howto/blob/main/zh/README.md) | [Українська](https://github.com/luongnv89/claude-howto/blob/main/uk/README.md)
...
**Is this maintained?** Actively. The guide is synced with every Claude Code release. Current version: v2.1.119 (April 2026), compatible with Claude Code 2.1+.
...
**Can I use this with Claude Sonnet / Haiku / Opus?** Yes. All templates work with Claude Sonnet 4.6, Claude Opus 4.7, and Claude Haiku 4.5.
...
- [https://github.com/anthropics/claude-code/releases/tag/v2.1.119](https://github.com/anthropics/claude-code/releases/tag/v2.1.119)
- [https://github.com/anthropics/claude-code/releases/tag/v2.1.113](https://github.com/anthropics/claude-code/releases/tag/v2.1.113) **Compatible Models**: Claude Sonnet 4.6, Claude Opus 4.7, Claude Haiku 4.5