...
[Website](https://www.rtk-ai.app/) • [Install](#installation) • [Troubleshooting](https://www.rtk-ai.app/guide/troubleshooting) • [Architecture](https://github.com/rtk-ai/rtk/blob/master/ARCHITECTURE.md) • [Discord](https://discord.gg/RySmvNF5kF)
...
- **[INSTALL.md](https://github.com/rtk-ai/rtk/blob/master/INSTALL.md)** — detailed installation reference
- **[ARCHITECTURE.md](https://github.com/rtk-ai/rtk/blob/master/ARCHITECTURE.md)** — system design and technical decisions
- **[CONTRIBUTING.md](https://github.com/rtk-ai/rtk/blob/master/CONTRIBUTING.md)** — contribution guide
- **[SECURITY.md](https://github.com/rtk-ai/rtk/blob/master/SECURITY.md)** — security policy

RTK can collect **anonymous, aggregate usage metrics** once per day. Telemetry is **disabled by default** and requires **explicit opt-in consent** (GDPR Art. 6, 7) during `rtk init` or via `rtk telemetry enable`. This data helps us build a better product: identifying which commands need filters, which filters need improvement, and how much value RTK delivers. For the full list of fields, data handling, and contributor guidelines, see **[docs/TELEMETRY.md](https://github.com/rtk-ai/rtk/blob/master/docs/TELEMETRY.md)**.
...
![Star History Chart](https://camo.githubusercontent.com/3ad97454aeffc55c763b5cc4263c0b23496a9247db0283b29893a22e7d6725ab/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f63686172743f7265706f733d72746b2d61692f72746b26747970653d64617465266c6567656e643d746f702d6c656674)

](https://www.star-history.com/?repos=rtk-ai%2Frtk&type=date&legend=top-left)

## StarMapper

[

![StarMapper](https://camo.githubusercontent.com/7fe2fbba124c0e1daa450fbdcc046fb28749e41b59d4f485afe9ad52f8d0a615/68747470733a2f2f737461726d61707065722e6272756e696175782e636f6d2f6170692f6d61702d696d6167652f72746b2d61692f72746b)

](https://starmapper.bruniaux.com/rtk-ai/rtk)

## Core team

- **Patrick Szymkowiak** — Founder [GitHub](https://github.com/pszymkowiak) · [LinkedIn](https://www.linkedin.com/in/patrick-szymkowiak/)
- **Florian Bruniaux** — Core contributor [GitHub](https://github.com/FlorianBruniaux) · [LinkedIn](https://www.linkedin.com/in/florian-bruniaux-43408b83/)
- **Adrien Eppling** — Core contributor [GitHub](https://github.com/aeppling) · [LinkedIn](https://www.linkedin.com/in/adrien-eppling/)
